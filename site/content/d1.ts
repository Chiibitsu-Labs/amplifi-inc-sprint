...
<h2>You already named this</h2>
<p>The intake asked what single thing, written down, would save the most rework. The answer was clear:</p>
...
<div class="grid grid-2">
  <div class="card">
    <h3>AI is the librarian. You are the curators.</h3>
    <p>The team owns and contributes the knowledge. The AI files it, keeps it tidy, and fetches it on demand. The knowing is human; the upkeep is the AI's job — not another manual chore.</p>
  </div>
  <div class="card">
    <h3>Build just in time, not the cathedral.</h3>
...
<div class="timeline">
  ...
  <div class="tl-mark"><div class="d">Later — Obsidian, org-wide</div><div class="t">A linked knowledge graph the whole organization reads from, not just the analyst function.</div></div>
</div>
